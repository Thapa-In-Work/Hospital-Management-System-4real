...
// IMPORTANT: The PHP block ends immediately here. No space or newline after the closing tag.
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo $pageTitle ?? 'Doctors Management'; ?></title>
    ...
    <div class="dashboard-container">
        <div class="sidebar" style="position: fixed; height: 100vh;">
            ...
            <nav>
                ...
                <a href="doctors.php" class="nav-link active"><i class="fas fa-user-md"></i> Doctors</a>
                
                <a href="../patients/patients.php" class="nav-link"><i class="fas fa-wheelchair"></i> Patients</a>
